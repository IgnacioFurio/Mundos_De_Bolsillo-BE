  ...
  async up (queryInterface, Sequelize) {
    ...
    */
    await queryInterface.bulkInsert('Knowledge', [
      //Tallin
      {title: "La venganza de Tallin", description: "Tallin está planeando vengarse de tu familia.", veracity: false, about_character_id: 2, heard_from_character_id: null, about_location_id: null, heard_on_location_id: null, createdAt: "2023-02-22 00:00:00", updatedAt: "2023-02-22 00:00:00"},
      ...
      {title: "Amores del pasado", description: "Tallin estáa completamente enamorado de Wood Lee.", veracity: false, about_character_id: 2, heard_from_character_id: null, about_location_id: null, heard_on_location_id: null, createdAt: "2023-02-22 00:00:00", updatedAt: "2023-02-22 00:00:00"},
      //Cerneas
      ...
      {title: "Druida", description: "Cerneas puede cambiar su foram a la de un animal.", veracity: true, about_character_id: 9, heard_from_character_id: null, about_location_id: null, heard_on_location_id: null, createdAt: "2023-02-22 00:00:00", updatedAt: "2023-02-22 00:00:00"},
    ], {});
  },
