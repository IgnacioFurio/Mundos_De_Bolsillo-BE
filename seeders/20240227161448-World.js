  ...
  async up (queryInterface, Sequelize) {
    ...
    */
    await queryInterface.bulkInsert('Worlds', [
      {name: 'Abeir-Toril', description: "El planeta del Reinoespacio con más población de seres inteligentes, y prácticamente cada criatura que ha existido en el multiverso, ha existido en Toril en alguna de sus épocas.​ Está compuesto por tres partes de agua y de varios continentes e islas, incluidos Faerûn, Kara-Tur, Zakhara, Abeir Retornado (que ocupa el lugar en donde anteriormente estaba Maztica y posiblemente Anchorome​), Osse y Katashaka.", createdAt: "2023-02-22 00:00:00", updatedAt: "2023-02-22 00:00:00"},
      {name: 'Barovia', description: "En Barovia la noche es una maldición. Con el fi de la luz del día las almas condenadas se deslizan desde los muros del Castillo de Ravenloft bajo las órdenes del señor de estas tierras. Este es el reino del vampiro Conde Strahd von Zarovich.", createdAt: "2023-02-22 00:00:00", updatedAt: "2023-02-22 00:00:00"},
